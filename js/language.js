;(function(window,document){
	...
	var JF_cn="ft"+window.location.hostname.toString().replace(/\./g,"");
	...
	window.fontConversion = fontConversion;
	window.curFontType = function curFontType(){
		// 导出当前简繁状态
		return getCookie(JF_cn);
	};
	// 使用时用window.curFontType()获取状态
})(window,document)
